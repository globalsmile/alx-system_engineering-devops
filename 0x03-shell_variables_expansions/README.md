...
[13-print_float](./13-print_float) - Write a script that prints a number with two decimal places. The number will be stored in the environment variable NUM.
...
[103-water_and_stir](./103-water_and_stir) - Write a script that prints every other line from the input, starting with the first line.
